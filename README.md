...
**Step 1: Sync weather data from NWS API**
```bash
...
# Response:
# {"synced": 42, "locations": ["Chicago, IL", "Austin, TX", "Seattle, WA"], "errors": []}
```

**Step 2: Generate embeddings (run the notebook)**
```bash
# Option A: Run from Databricks UI
# Open: notebooks/ingest_weather_embeddings
# Click: "Run All"

# Option B: Schedule as a job for automatic updates
...
curl -X POST https://your-app.cloud.databricks.com/weather/search \
  -H "Content-Type: application/json" \
  -d '{
    "query": "tornado warnings in midwest",
    "top_k": 5
  }'
...
#       "chunk_text": "...take shelter immediately...",
#       "similarity": 0.89
#     },
#     ...
#   ]
